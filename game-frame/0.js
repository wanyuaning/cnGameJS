...
var canvas = document.createElement("canvas"); canvas.innerHTML = "请使用支持canvas的浏览器查看"; canvas.id = "gameCanvas";
var wrap = document.getElementById("wrap"); wrap.appendChild(canvas);

var srcObj = { startSrc: "images/v0/gamestart.png", backgroundSrc: "images/v0/background.png", enemySrc: "images/v0/enemy.png", playerSrc: "images/v0/player.png", stoneSrc: "images/v0/stone.png", stoneSrc2: "images/v0/stone2.png", pillarSrc: "images/v0/pillar.png", bulletSrc: "images/v0/bullet.png" };
 ...
 * 游戏开始界面对象
 **/
cnGame.loader.start([srcObj.startSrc], {
    initialize: function () {
        //画出开始界面
        cnGame.context.drawImage(cnGame.loader.loadedImgs[srcObj.startSrc], 0, 0, cnGame.width, cnGame.height);
